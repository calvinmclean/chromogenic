...
class ImageManager(BaseDriver):
    ...
    def upload_image(self, image_location, image_name, export_format, *args,
                     **kwargs):
        return self.export_image(image_location, image_name, export_format,
                                 **kwargs)
    ...
    def _large_file_hash(self, file_path):
        ...
        with open(file_path, 'rb') as f:
            for chunk in iter(lambda: f.read(md5_hash.block_size * 128),
